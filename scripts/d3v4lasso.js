d4.lasso = function() {
    ...
    function lasso() {
        ...
        console.log("lasso called on")
        console.log(this);
        var _this = d4.select(this[0][0]);
        ...
        function dragstart() {
            ...
            if(hoverSelect===true) {
                items.on("mouseover.lasso",function() {
                    ...
                    d4.select(this)[0][0].hoverSelected = true;
                });
            }
        ...
        function dragmove() {
            ...
            var x = d4.event.sourceEvent.clientX;
            var y = d4.event.sourceEvent.clientY;
            // Get mouse position within drawing area, used for rendering
            var tx = d4.mouse(this)[0];
            var ty = d4.mouse(this)[1];
            ...
            // Tag possible items
            d4.selectAll(items[0].filter(function(d) {return (d.loopSelected && isPathClosed) || d.hoverSelected;}))
    ...
    lasso.items  = function(_) {
        ...
        console.log(items)
        // items[0].forEach(function(d) {
        items._groups.forEach(function(d) {
            var item = d4.select(d);
